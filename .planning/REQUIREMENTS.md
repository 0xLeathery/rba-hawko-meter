...
- [x] **INFRA-03**: Test fixtures directory with sample HTML, PDF text, and CSV data for scraper tests
- [x] **INFRA-04**: Per-module coverage check script enforcing 85% minimum per file in pipeline/
